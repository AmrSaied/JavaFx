...
public class TBillseller {
 ...
 TBillseller(String id,String parcode, String name, String amount, String priceSell,String totall) {
     ...
     */
    public void setPricebuy(String priceSell) {
