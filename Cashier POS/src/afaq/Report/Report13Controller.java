 ...
 * @author AMR SAID
 */
public class Report13Controller implements Initializable , ControlledScreen {
    ...
    public void FillTable() throws SQLException {
        ...
        while (DB.rs.next()) {
            ...
            data.add(new TableReport(DB.rs.getString("user_name"), DB.rs.getString("bill_no"), DB.rs.getString("com_name"), DB.rs.getString("tot_price"), DB.rs.getString("paid"), DB.rs.getString("bill_date"), DB.rs.getString("change")));
    ...
    public void SearchParcode() throws SQLException {
        ...
        String Sql = "SELECT *  FROM  buy_bills WHERE bill_date between '" + date + "' and '" + date2 + "'";
      
       
        if (!comboBox1.getSelectionModel().isEmpty()) {
            Sql = "SELECT *  FROM  buy_bills  WHERE com_name = '" + comboBox1.getValue() + "' and  bill_date between '" + date + "' and '" + date2 + "'";
