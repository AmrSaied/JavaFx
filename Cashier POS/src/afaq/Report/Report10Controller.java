 ...
 * @author AMR SAID
 */
public class Report10Controller implements Initializable  , ControlledScreen {
    ...
    public void FillTable() throws SQLException {
        ...
        while (DB.rs.next()) {
            ...
            data.add(new TableReport("", DB.rs.getString("com_name"), DB.rs.getString("address"), DB.rs.getString("tel"), DB.rs.getString("note"), DB.rs.getString("note"), DB.rs.getString("note")));
