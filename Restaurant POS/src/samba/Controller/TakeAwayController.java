 ...
 * @author belal
 */
public class TakeAwayController implements Initializable, ControlledScreen {
    ...
    @FXML
    Button n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, OrderID;
    double totall = 0;
...
//            APM.setPrefWidth(width);
    ...
    void setCurrent(TuserPermission permission) throws SQLException {
        data.clear();
        OrderID.setText(" جديد");
        this.cus_name = "";
        this.Delivery = "";
        this.user_name = permission.getUser_name();
        this.permission = permission;
        header.setText(" طلبات سريعة");
    ...
    public void insertBuyed() throws SQLException {
        ...
        sql = "INSERT INTO  sell_bills (kitchen_S ,delivery ,del_S ,bill_no ,cus_name  ,tot_price ,bill_date ,bill_Time ,user_name,T_name,T_S, `Action`)VALUES ("
                + " '1',  '','', '" + ponid.getText() + "' ,  '', '" + totalls.getText() + "',  '" + date.getText() + "',  '" + time.getText() + "',  '" + user_name + "','','',' طلبات سريعة');";
