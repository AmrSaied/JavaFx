...
public class DeliverypageController implements Initializable, ControlledScreen {
    ...
    String cus_name = "", Delivery = "", user_name = "";
    int pagefrom = 0;
    String row_id;
...
//            APM.setPrefWidth(width);
    ...
    public void newOrder() throws SQLException {
        ...
        FXMLLoader loder = Samba.FXDOrder;
        OrderController scenseController = loder.getController();
    ...
    public void setCurrent(String cus_name, String Delivery, TuserPermission permission) throws SQLException {
        data.clear();
    ...
    void setCurrent(TDelivery InsertData) throws SQLException {
        ...
        this.cus_name = InsertData.getEmp_name();
        this.Delivery = InsertData.getCus_name();
    ...
    public void insertBuyed() throws SQLException {
        ...
        if (pagefrom == 1) {
            sql = "INSERT INTO  sell_bills (kitchen_S ,delivery ,del_S ,bill_no ,cus_name  ,tot_price ,bill_date ,bill_Time ,user_name,T_name,T_S, `Action`)VALUES ("
                    + " '1',  '" + Delivery + "','1', '" + ponid.getText() + "' ,  '" + cus_name + "', '" + totalls.getText() + "',  '" + date.getText() + "',  '" + time.getText() + "',  '" + user_name + "','','','خدمة توصيل');";
...
//            db.statemen.executeUpdate("delete  FROM `sell_bills` WHERE id = '" + tDelivery.getId() + "'");
    ...
    public void finishorder() throws SQLException {
        ...
        String sql = "update sell_bills set  del_S = '0'  where id = '" + row_id + "'";
