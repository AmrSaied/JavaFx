...
public  TBillCashier(String id,String billNumber, String total, String buyprices, String reprices, String databill,String state) {
            this.id = new SimpleStringProperty(id);
            this.billNumber = new SimpleStringProperty(billNumber);
            this.total = new SimpleStringProperty(total);
            this.reprices = new SimpleStringProperty(reprices);
...
public  TBillCashier(String id,String billNumber, String total) {
            this.id = new SimpleStringProperty(id);
            this.billNumber = new SimpleStringProperty(billNumber);
            this.total = new SimpleStringProperty(total);
